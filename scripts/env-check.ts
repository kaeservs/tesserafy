...
const COMMANDS: Record<string, Need> = {
  ...
  process: { required: ['SUPABASE_URL', 'SUPABASE_SERVICE_ROLE_KEY', 'ANTHROPIC_API_KEY'], optional: ['OLLAMA_URL', 'EMBED_MODEL'] },
  ingest: { required: ['SUPABASE_URL', 'SUPABASE_SERVICE_ROLE_KEY', 'ANTHROPIC_API_KEY'], optional: ['OLLAMA_URL', 'EMBED_MODEL'] },
  insights: { required: ['SUPABASE_URL', 'SUPABASE_SERVICE_ROLE_KEY', 'ANTHROPIC_API_KEY'], optional: ['OLLAMA_URL', 'EMBED_MODEL'] },
